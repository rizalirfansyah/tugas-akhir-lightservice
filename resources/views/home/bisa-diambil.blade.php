    ...
    {{-- Search bar --}}
        <form class="flex items-center pt-4 space-x-1 ml-3">
            ...
            <div class="relative w-32 lg:w-96 md:w-80 sm:w-72">
                ...
                <input type="text" id="simple-search" class="border text-sm rounded-lg block w-full pl-10 p-2.5  bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Cari pelanggan..." required>
            </div>
