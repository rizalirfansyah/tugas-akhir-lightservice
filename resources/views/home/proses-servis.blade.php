<title>Light Service | Proses Servis</title>
...
<x-app-layout>
   ...
   <div class="h-screen ml-14 mb-10 md:ml-64">
    ...
    <h2 class="text-3xl mt-4 items-center text-center text-gray-400">Data Proses Servis</h2>
       ...
       {{-- Search bar --}}
           <form class="flex items-center pt-4 space-x-1 ml-3">
               ...
               <div class="relative w-32 lg:w-96 md:w-80 sm:w-72">
                   ...
                   <input type="text" id="simple-search" class="border text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari pelanggan..." required>
               </div>
           ...
           <div class="w-full overflow-x-auto">
               ...
               <tbody class="divide-y divide-gray-700 bg-gray-800">
                   ...
                   <td class="px-4 py-3 text-xs">
                       <span class="px-2 py-1 font-semibold leading-tight rounded-full bg-green-700 text-green-100"> Sedang dikerjakan </span>
                   </td>
                   <td class="px-4 py-3 text-xs">
                    <button class="text-gray-100 bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg px-2 py-2 text-center mr-2">Bisa diambil</button>
                   </td>
                   </tr>
                   ...
                   <td class="px-4 py-3 text-xs">
                       <span class="px-2 py-1 font-semibold leading-tight text-yellow-700 bg-yellow-100 rounded-full items-center"> Belum cek </span>
                   </td>
                   <td class="px-4 py-3 text-xs">
                    <button class="text-gray-100 bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg px-2 py-2 text-center mr-2">Bisa diambil</button>
                   </td>
