    ...
    <div class="flex justify-between">
        ...
        <form class="flex items-center pt-4 space-x-1 ml-3">
            ...
            <div class="relative w-32 lg:w-96 md:w-80 sm:w-72">
                ...
                <input type="text" id="simple-search" class="border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  bg-gray-700 border-gray-600 placeholder-gray-400" placeholder="Cari data servis..." required>
            </div>
            <button class="p-1.5 lg:p-2.5 -ml-2 text-sm font-medium bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-600">
