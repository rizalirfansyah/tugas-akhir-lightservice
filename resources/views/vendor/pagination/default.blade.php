...
<nav role="navigation"
  ...
  <div class="flex justify-between flex-1 sm:hidden">
    ...
    {{-- previous disable --}}
    <span
      class="relative inline-flex items-center px-4 py-2 text-sm font-medium leading-5 bg-gray-900 border border-gray-300 rounded text-gray-400 dark:bg-secondary-700 dark:border-secondary-600">
  ...
  <div class="flex-col hidden lg:flex-row sm:flex-1 sm:flex sm:items-center sm:justify-between">
    <div>
      <p class="text-sm leading-5 dark:text-gray-300 mr-5">
